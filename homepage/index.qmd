...
| Data Management | [Best practices when working with bioinformatics data](before_data_management.qmd) |
...
| Day  | Session  |
|--------|--------|
| Monday  | [Welcome, introduction](course_intro.qmd)  |
|   | [Discussion: Data Management](course_data_management.qmd)  |
...
|   | [Introduction to environments](course_environments.qmd) |
| Tuesday  | QC of sequencing data   |

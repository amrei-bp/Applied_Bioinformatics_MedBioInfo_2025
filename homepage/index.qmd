...
We will sometimes be sharing ideas, scripts etc. during the course. For this purpose, I have set up a page on HackMD that we all can access and edit: [living document at HackMD](https://hackmd.io/@amrei/SJoLZbphgl/edit). 
...
|   | [Nextflow tutorial](course_nextflow_tutorial.qmd) |
